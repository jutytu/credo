# Calculating the PDF for correlation of cosmic rays and earthquakes intensity changes over a 
# period of 1675 days (335 intervals of 5 days).
...
def pdf(d, l, t, shift,shift2):
    ...
    c.index = range(len(c))
    c['pa median'] = c['pa delta3'].median()  # calculating the median before removing empty elements

    c = c[(c['pa delta3'] > 0)]  # delete intervals with no data days 
